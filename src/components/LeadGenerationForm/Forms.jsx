...
function FormsIndiaorBooks() {
    const cardData = [
      ...
      const links = ["/formsindia","/formsbooks"];
          ...
          <div className=" w-[80vw]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 p-4 sm:p-10">
              {cardData.map((card, index) => (
                ...
                >
                  <div className="p-4 bg-amber-600 h-48 border flex flex-col justify-center items-center rounded-2xl hover:bg-amber-700 hover:shadow-md hover:scale-105 transition-transform duration-1000">
...
export default FormsIndiaorBooks