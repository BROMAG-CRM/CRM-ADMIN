...
function MarketingLeadsBooks() {
  ...
  const links = [
    "/new_leadsmarketingbooks",
    "/followup_leadsmarketingbooks",
    "/connected_leadsmarketingbooks",
    "/notconnected_leadsmarketingbooks",
  ];
...
export default MarketingLeadsBooks;
